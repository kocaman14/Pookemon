...
function updatePosition() {
  setPookachu((pre) => {
let newX = pre.xPosition;
let newY = pre.yPosition;
if (pre.direction === 'right') {
if (newX < boundaries.xAxis.max) {
newX = newX + 1;
}
} else if (pre.direction === 'left') {
if (newX > boundaries.xAxis.min) {
newX = newX - 1;
}
} else if (pre.direction === 'down') {
if (newY < boundaries.yAxis.max) {
newY = newY + 1;
}
} else if (pre.direction === 'up') {
if (newY > boundaries.yAxis.min) {
newY = newY - 1;
}
}
return {
